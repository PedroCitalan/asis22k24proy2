...
namespace Capa_Vista_AmmyCatun
{
    public partial class Transporte : Form
    {
        ...
        private void Btn_Modificar_Click(object sender, EventArgs e)
        {
            ...
            if (!int.TryParse(Txt_IDVeh.Text, out idVehiculo) || idChofer <= 0)
            {
            ...
            var confirmResult = MessageBox.Show("¿Está seguro de que desea modificar al vehículo con ID " + idChofer + "?",
            ...
            if (confirmResult == DialogResult.Yes)
            {
                ...
                controladorVehiculo.modificarVehiculo(idVehiculo, numeroPlaca, marca, color, descripcion,
        ...
        private void Btn_Ingresar_Click(object sender, EventArgs e)
        {
            ...
            // Llama al método para guardar el vehículo
            controladorVehiculo.guardarVehiculo(numeroPlaca, marca, color, descripcion,
                                                                 horaLlegada, horaSalida, pesoTotal, idChofer);
        ...
        {
            {
                string idVehiculo = Txt_IDVeh.Text;
                ...
                var confirmResult = MessageBox.Show("¿Está seguro de que desea eliminar al vehículo con ID " + idVehiculo + "?",
